                                ...
                                <div class="col-md-12">
                                    <div class="portlet box green">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-cogs"></i>Manage Admin Account
                                            </div>
                                        </div>
                                        <div class="portlet-body">
                                            <div class="tabbable-line">
                                                <ul class="nav nav-tabs ">
                                                    <li class="active">
                                                        <a href="#tab_mng_admin_account" data-toggle="tab"><i class="fa fa-building"></i> Manage Admin Account </a>
                                                    </li>
                                                </ul>
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="tab_mng_admin_account">
                                                        <div class="row">
                                                            <form role="form">
                                                                    ...
                                                                    <div class="form-body">
                                                                        <div class="col-md-4">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                <input type="text" class="form-control" name="admin_user_name" id="admin_user_name" value="">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                ...
                                                                                <label for="admin_acc_pass">Password*</label>
                                                                            </div>
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                <label for="chk_role">Role:</label>
                                                                                <div class="md-checkbox-inline">
                                                                                    <div class="md-checkbox">
                                                                                        <input type="checkbox" name="chk_role" id="chk_role" class="md-check" value="Admin">
                                                                                        <label for="chk_role">
                                                                                            <span class="inc"></span>
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                <label for="chk_role">School Name:</label>
                                                                                <div class="md-checkbox-inline">
                                                                                    <div class="md-checkbox">
                                                                                        <input type="checkbox" name="chk_school_name" id="chk_school_name" class="md-check" value="Bhopal Nobles Public School">
                                                                                        <label for="chk_school_name">
                                                                                            <span class="inc"></span>
                                                                                            <span class="check"></span>
                                                                                            <span class="box"></span>
                                                                                            Bhopal Nobles Public School
                                                                                        </label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-offset-4 col-md-8">
                                                                <div
                                                                    ...
                                                                    <button type="button" class="btn green" name="save_admin_info" id="save_admin_info"><i class="fa fa-save"></i>&nbsp;&nbsp;Save Admin Account Info</button>
...
//    echo script_tag('assets/js/global/scripts/quick-sidebar.min.js');
    echo script_tag('assets/js/app-js/manage/manage-admin-acc/manage-admin-account.js');
    ?>
</html>
<script type="text/javascript">
    $(document).ready(function () {
        new WKISCHOOL.ManageAdminAccount("<?php echo base_url(); ?>");
    });
</script>