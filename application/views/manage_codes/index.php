                ...
                <div class="page-head">
                    <div class="container">
                        <div class="page-title">
                            <h1>Manage and Merge Codes
                                <small>manage codes & merge codes</small>
                            </h1>
                        </div>
                    </div>
                </div>
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span>Manage and Merge Codes</span>
                            </li>
                        </ul>
                                        ...
                                        <div class="portlet-body">
                                            <div class="tabbable-line">
                                                ...
                                                <ul class="nav nav-tabs ">
                                                    <li id="tab_mng_codes">
                                                        <a href="#mng_codes" class="tab_val_header_class" data-toggle="tab"><i class="fa fa-wrench"></i> Manage Codes </a>
                                                    </li>
                                                    <li id="tab_merge_codes">
                                                        <a href="#merge_codes" class="tab_val_header_sub" data-toggle="tab"><i class="fa fa-expand"></i> Merge Codes </a>
                                                    </li>
                                                </ul>

                                                <div class="tab-content">
                                                    <div class="tab-pane" id="mng_codes">
                                                        <div class="row">
                                                            <div class="col-md-offset-1 col-md-10">
                                                                <h4><i class="fa fa-plus"></i>&nbsp;&nbsp;Create New Code</h4>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                                    ...
                                                                    <div class="form-body">
                                                                        <div class="col-md-offset-1 col-md-3">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                <select class="form-control" name="drop_code_category_name" id="drop_code_category_name">
                                                                                    <option value=""></option>
                                                                                    <option value="">----Select-code-category-name----</option>
                                                                                </select>
                                                                                <label for="drop_code_category_name">Code Category Name</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                <input type="text" class="form-control" name="code_name" id="code_name" value="">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-offset-2 col-md-8">
                                                                <div class="form-group form-md-line-input form-md-floating-label">
                                                                    <button type="button" class="btn green" name="create_code" id="create_code"><i class="fa fa-save"></i>&nbsp;&nbsp;Create Code</button>
                                                                    <button type="button" id="btn_cancel" class="btn default">Cancel</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane" id="merge_codes">
                                                        <div class="row">
                                                            <div class="col-md-offset-1 col-md-10">
...
//    echo script_tag('assets/js/global/scripts/quick-sidebar.min.js');
    echo script_tag('assets/js/app-js/manage/manage-codes/manage-codes.js');
    ?>
</html>
<script type="text/javascript">
    $(document).ready(function () {
        new WKISCHOOL.ManageCodes("<?php echo base_url(); ?>");
    });
</script>