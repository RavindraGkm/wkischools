                ...
                <div class="page-head">
                    <div class="container">
                        <div class="page-title">
                            <h1>Manage Country, State, City
                                <small>manage your own country, state and city</small>
                            </h1>
                        </div>
                    </div>
                </div>
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span>Manage Country, State and City</span>
                            </li>
                        </ul>
                                        ...
                                        <div class="portlet-body">
                                            <div class="tabbable-line">
                                                ...
                                                <ul class="nav nav-tabs ">
                                                    <li id="tab_mng_city">
                                                        <a href="#mng_city" class="tab_val_header_city" data-toggle="tab"><i class="fa fa-wrench"></i> Manage City </a>
                                                    </li>
                                                    <li id="tab_mng_state">
                                                        <a href="#mng_state" class="tab_val_header_state" data-toggle="tab"><i class="fa fa-wrench"></i> Manage State </a>
                                                    </li>
                                                    <li id="tab_mng_country">
                                                        <a href="#mng_country" class="tab_val_header_country" data-toggle="tab"><i class="fa fa-wrench"></i> Manage Country </a>
                                                    </li>
                                                </ul>

                                                <div class="tab-content">
                                                    <div class="tab-pane" id="mng_city">
                                                        <div class="row">
                                                            <div class="col-md-offset-1 col-md-10">
                                                                <h4><i class="fa fa-plus"></i>&nbsp;&nbsp;Create New City</h4>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                                    ...
                                                                    <div class="form-body">
                                                                        <div class="col-md-offset-1 col-md-3">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                <select class="form-control" name="drop_state_name" id="drop_state_name">
                                                                                    <option value=""></option>
                                                                                    <option value="">----Select-State----</option>
                                                                                </select>
                                                                                <label for="drop_state_name">State</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-offset-2 col-md-8">
                                                                <div class="form-group form-md-line-input form-md-floating-label">
                                                                    <button type="button" class="btn green" name="create_city" id="create_city"><i class="fa fa-save"></i>&nbsp;&nbsp;Save City</button>
                                                                    <button type="button" id="btn_cancel" class="btn default">Cancel</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane" id="mng_state">
                                                        <div class="row">
                                                            <div class="col-md-offset-1 col-md-10">
                                                                <h4><i class="fa fa-plus"></i>&nbsp;&nbsp;Create New State</h4>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            <form role="form">
                                                                <div class="section-school-info">
                                                                    <div class="form-body">
                                                                        <div class="col-md-offset-1 col-md-3">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                <select class="form-control" name="drop_country_name" id="drop_country_name">
                                                                                    <option value=""></option>
                                                                                    <option value="">----Select-country----</option>
                                                                                </select>
                                                                                <label for="drop_country_name">Country</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-offset-2 col-md-8">
                                                                <div class="form-group form-md-line-input form-md-floating-label">
                                                                    <button type="button" class="btn green" name="create_state" id="create_state"><i class="fa fa-save"></i>&nbsp;&nbsp;Save State</button>
                                                                    <button type="button" id="btn_cancel" class="btn default">Cancel</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane" id="mng_country">
                                                        <div class="row">
                                                            <div class="col-md-offset-1 col-md-10">
                                                                <h4><i class="fa fa-plus"></i>&nbsp;&nbsp;Create New Country</h4>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-offset-1 col-md-11">
                                                                <div class="form-group form-md-line-input form-md-floating-label">
                                                                    <button type="button" class="btn green" name="save_country_name" id="save_country_name"><i class="fa fa-save"></i>&nbsp;&nbsp;Save Country</button>
...
//    echo script_tag('assets/js/global/scripts/quick-sidebar.min.js');
    echo script_tag('assets/js/app-js/manage/manage-country-state-city/manage-country-state-city.js');
    ?>
</html>
<script type="text/javascript">
    $(document).ready(function () {
        new WKISCHOOL.ManageCountryStateCity("<?php echo base_url(); ?>");
    });
</script>