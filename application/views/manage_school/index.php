                        ...
                        <ul class="dropdown-menu pull-left manage-menu-size">
                            <li class="dropdown-submenu active">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="">
                                        <a class="nav-link" href="#manage_default_session" data-toggle="modal"> Manage
                                            Default Session</a>
                                    </li>
                                </ul>
                            </li>
        ...
        <div class="page-head">
            <div class="container">
                ...
                <div class="page-title">
                    <h1>Manage School
                        <small>School &amp; Admin Account</small>
                    </h1>
                </div>
                <!-- END PAGE TITLE -->
                <!-- BEGIN PAGE TOOLBAR -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-head">
                    <div class="container">
                        ...
                        <div class="page-title">
                            <h1>Manage School
                                <small>admin school & school</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                                    ...
                                    <div class="portlet box green">
                                        ...
                                        <div class="portlet-body">
                                            <div class="tabbable-line">
                                                <ul class="nav nav-tabs ">
                                                    <li>
                                                        <a href="#tab_mng_admin_school" data-toggle="tab"><i class="fa fa-building"></i> Manage Admin School </a>
                                                    </li>
                                                    <li class="active">
                                                        <a href="#tab_mng_school" data-toggle="tab"><i class="fa fa-building"></i> Manage School </a>
                                                    </li>
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane" id="tab_mng_admin_school">
                                                        <p> I'm in Section 1. </p>
                                                        <p> Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex
                                                            ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.
                                                        </p>
                                                    </div>
                                                    <div class="tab-pane active" id="tab_mng_school">
                                                        <div class="row">
                                                            <form role="form">
                                                                <div class="form-body">
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="form-group form-md-line-input form-md-floating-label">
                                                                            <input type="text" class="form-control" id="form_control_1" value="">
                                                                            <label for="school_affiliation">Affiliation</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group form-md-line-input form-md-floating-label">
                                                                        ...
                                                                        <div class="form-group form-md-line-input form-md-floating-label">
                                                                            <input type="text" class="form-control" id="form_control_1" value="">
                                                                            <label for="school_web_address">Web Address</label>
                                                                        </div>
                                                                        <div class="form-group form-md-line-input form-md-floating-label">
                                                                            <input type="text" class="form-control" id="form_control_1" value="">
                                                                            <label for="school_email">Email</label>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="school_admission_no">School Type:</label><br/>
                                                                            <div class="md-checkbox-inline">
                                                                                <div class="md-checkbox">
                                                                                    <input type="checkbox" name="chk_school_type" id="chk_play_school" class="md-check">
                                                                                    <label for="chk_play_school">
                                                                                        <span class="inc"></span>
                                                                                        <span class="check"></span>
                                                                                        <span class="box"></span> Play School
                                                                                    </label>
                                                                                </div>
                                                                                <div class="md-checkbox">
                                                                                    <input type="checkbox" name="chk_school_type" id="chk_pri_school" class="md-check">
                                                                                    <label for="chk_pri_school">
                                                                                        <span class="inc"></span>
                                                                                        <span class="check"></span>
                                                                                        <span class="box"></span> Primery School
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="md-checkbox-inline">
                                                                                <div class="md-checkbox">
                                                                                    <input type="checkbox" name="chk_school_type" id="chk_sec_school" class="md-check">
                                                                                    <label for="chk_sec_school">
                                                                                        <span class="inc"></span>
                                                                                        <span class="check"></span>
                                                                                        <span class="box"></span> Sec. School
                                                                                    </label>
                                                                                </div>
                                                                                <div class="md-checkbox">
                                                                                    <input type="checkbox" name="chk_school_type" id="chk_high_sec_school" class="md-check">
                                                                                    <label for="chk_high_sec_school">
                                                                                        <span class="inc"></span>
                                                                                        <span class="check"></span>
                                                                                        <span class="box"></span> Higher Sec. School
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="md-checkbox-inline">
                                                                                <div class="md-checkbox">
                                                                                    <input type="checkbox" name="chk_school_type" id="chk_other_school" class="md-check">
                                                                                    <label for="chk_other_school">
                                                                                        <span class="inc"></span>
                                                                                        <span class="check"></span>
                                                                                        <span class="box"></span> Others
...
echo script_tag('assets/js/app-js/manage/manage-school/manage-admin-account.js');
?>
</html>
