                ...
                <div class="page-head">
                    <div class="container">
                        <div class="page-title">
                            <h1>Manage Subject and Class
                                <small>manage subjects & class relation</small>
                            </h1>
                        </div>
                    </div>
                </div>
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span>Manage Subject and Class</span>
                            </li>
                        </ul>
                                ...
                                <div class="col-md-12">
                                    <div class="portlet box green">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-cogs"></i><span id="header_title">Manage Subject and class relation</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body">
                                            <div class="tabbable-line">
                                                ...
                                                <ul class="nav nav-tabs ">
                                                    <li id="tab_mng_class">
                                                        <a href="#mng_class" class="tab_val_header_class" data-toggle="tab"><i class="fa fa-building"></i> Manage Class </a>
                                                    </li>
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane" id="mng_class">
                                                        <div class="row">
                                                            <div class="col-md-offset-1 col-md-10">
                                                                <h4><i class="fa fa-plus"></i>&nbsp;&nbsp;Create New Class</h4>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                                    ...
                                                                    <div class="form-body">
                                                                        <div class="col-md-offset-1 col-md-2">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                <input type="text" class="form-control" name="class_name" id="class_name" value="">
                                                                                <label for="class_name">Class Name</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                <input type="text" class="form-control" name="class_code" id="class_code" value="">
                                                                                <label for="class_code">Class Code</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                <input type="text" class="form-control" name="class_level" id="class_level" value="">
                                                                                <label for="class_level">Class Level</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                <select class="form-control" name="drop_class_segment" id="drop_class_segment">
                                                                                    <option value=""></option>
                                                                                ...
                                                                                <label for="drop_class_segment">Class Segment</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                <select class="form-control" name="drop_class_stream" id="drop_class_stream">
                                                                                    <option value=""></option>
                                                                                    <option value="">----Select Stream----</option>
                                                                                    <option value="English">English</option>
                                                                                    <option value="Science">Science</option>
                                                                                </select>
                                                                                <label for="drop_class_stream">Stream</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-offset-2 col-md-8">
                                                                <div class="form-group form-md-line-input form-md-floating-label">
                                                                    <button type="button" class="btn green" name="save_class_info" id="save_class_info"><i class="fa fa-save"></i>&nbsp;&nbsp;Save Class Info</button>
                                                            ...
                                                            <form role="form">
                                                                <div class="section-school-info">
                                                                    <div class="form-body">
                                                                        <div class="col-md-offset-1 col-md-2">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                <input type="text" class="form-control" name="admin_user_name" id="class_name" value="">
                                                                                <label for="class_name">Class Name</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                <input type="text" class="form-control" name="admin_acc_pass" id="admin_acc_pass" value="">
                                                                                <label for="admin_acc_pass">Class Level</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        new WKISCHOOL.ManageSubjectClassRelation("<?php echo base_url(); ?>");
    });
</script>